...
namespace Garant.Platform.Abstractions.Franchise
{
    ...
    public interface IFranchiseService
    {
        ...
        Task<IndexOutput> FilterFranchisesWithPaginationAsync(string typeSort, string viewCode, string categoryCode, double minPriceInvest, double maxPriceInvest, double minProfit, double maxProfit, int pageNumber, int countRows, bool isGarant = false);
